# DbMaster 隐私政策 / Privacy Policy

**最后更新日期 / Last Updated**: 2026-06-16
...
本页面托管于 GitHub Pages。任何更新推送到 `main` 分支的 `docs/privacy-policy.md` 后，通常会在 1-5 分钟内自动重新部署。

Hosted on GitHub Pages. Updates to `docs/privacy-policy.md` on the `main` branch are automatically redeployed within 1-5 minutes.
